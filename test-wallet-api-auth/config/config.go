...
type (
	...
	// HTTP -.
	HTTP struct {
		Port string `env-required:"true" yaml:"port" env:"AUTH_HTTP_PORT"`
	}
	...
	Tokenikzer struct {
		Expiration int    `env:"TOKEN_EXPIRATION" env-required:"true"`
		PassPhrase string `env:"TOKEN_PASSPHRASE" env-required:"true"`
	}
)
